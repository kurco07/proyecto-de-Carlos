...
const ImageButton = ({ data, creador }) => {
    ...
    return (
        <>
            <button onClick={() => navigate(`/reproductorMP4/${id}/${data.idVideoPublicacion}`)} style={{ borderRadius: '20px', padding: '10px', display: 'flex', alignItems: 'center', marginBottom: '20px', backgroundColor: id_capitulo == data.idVideoPublicacion ? '#D2EAFF' : '#FFFFFF', border: 'none' }}>
                <img src={data.miniatura} alt={data.tituloCapitulo} style={{ width: '400px', height: '225px', flexShrink: 0, borderRadius: '20px', background: '#C4C4C4', marginRight: '10px' }} />
                <div>
