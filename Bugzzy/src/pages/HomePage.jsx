  ...
  return (
    <div style={{
      ...
      <Container sx={{
        ...
        {/*prueba*/}
        <>
          <Box border={'1px solid #2d323a'} borderRadius={'0.75rem'} color={'#C5DD4A'} mt={'90px'} width={'670px'} display={'flex'}>
          ...
          <Box display={'flex'} gap={'10px'} flexDirection={'column'} justifyContent={'center'} padding={'20px'} width={'670px'} height={'150px'} mt={'20px'} bgcolor={'#C5DD4A'} borderRadius={'0.75rem'}>
            ...
            <Box onClick={(() => navigate('/profile'))} component={'button'} sx={{
              ...
              <Typography borderBottom={'1px solid #000000'} fontSize="12px">Configurar perfil</Typography>
        ...
        <Box width={'670px'} pt={'20px'} display={'flex'} justifyContent={'space-between'} alignItems={'center'}>
          <Typography variant="h5" color={'white'}>Comienza ahora</Typography>
          <Box component={'button'} sx={{
            ...
            <Typography borderBottom={'1px solid #ffffff60'} fontSize="12px">Cursos en progreso</Typography>
            <ArrowForwardIosIcon sx={{ ml: '5px' }} fontSize="" />
          </Box>
        </Box>
        ...
        <Box mt={'15px'} width={'670px'}>
          <Typography color={'white'} mb={'20px'} variant="h5" align="left" gutterBottom>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={4}>
              ...
              <Box display={'flex'} flexDirection={'column'} borderRadius={'0.75rem'} justifyContent={'center'} height={'300px'} padding={'10px'} color={'white'} bgcolor={'#0288d1'} textAlign="center">
            ...
            <Grid item xs={12} sm={4}>
              ...
              <Box display={'flex'} flexDirection={'column'} borderRadius={'0.75rem'} justifyContent={'center'} height={'300px'} padding={'10px'} color={'white'} bgcolor={'#0288d1'} textAlign="center">
                ...
                <Typography variant="subtitle2">
                  "Recomendado, los profesores responden a las preguntas de los comentarios"
                </Typography>
                <Box sx={{
                  '&:hover': {
                    transition: 'all 1s',
        ...
        <Box mt={3} width={'670px'}>
          ...
          }} mb={'10px'} display={'flex'} alignItems={'center'} justifyContent={'center'} padding={'30px'} bgcolor={'#FAD8D5'} borderRadius={'0.75rem'} >
          ...
          <Grid container spacing={3} justifyContent="center">
            <Grid item xs={12} md={6}>
              ...
              }} height={'250px'} mb={'10px'} flexDirection={'column'} display={'flex'} justifyContent={'initial'} padding={'30px'} bgcolor={'#FAD8D5'} borderRadius={'0.75rem'}>
            ...
            <Grid item xs={12} md={6}>
              ...
              }} mb={'10px'} height={'250px'} flexDirection={'column'} display={'flex'} justifyContent={'initial'} padding={'30px'} bgcolor={'#FAD8D5'} borderRadius={'0.75rem'}>
          ...
          <Grid mb={10} width={'670px'} container spacing={3}>
            {staffMembers.map((member, index) => (
              <Grid width={3} item xs={12} md={4} key={index}>
                ...
                }} display={'flex'} gap={'10px'} flexDirection={'column'} alignItems={'center'} justifyContent={'center'} height={'250px'} width={'210px'} mt={'10px'} padding={'20px'} borderRadius={'0.75rem'} color={'white'} bgcolor={'InfoText'} textAlign="center">
                  <Typography color={'#C5DD4A'} fontWeight={700} fontSize={'14px'} >
                    {member.name}
                  </Typography>
                  <Typography
